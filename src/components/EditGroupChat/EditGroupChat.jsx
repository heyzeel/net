...
const EditGroupChat = ({setShowEditGroup}) => {
    ...
    const handleSearch = async () => {
        ...
        try {
            const { data } = await axios.get(`${import.meta.env.VITE_URL}/api/user?search=${search}`, {
                headers: {
    ...
    const handleAdd = async(UserId)=>{
        const addUser = await axios.put(`${import.meta.env.VITE_URL}/api/chat/groupadd`,
        {
            userId:UserId,
    ...
    const handleRemove = async(UserId) => {
        ...
        const removeUser = await axios.put(`${import.meta.env.VITE_URL}/api/chat/groupremove`,
            {
                userId:UserId,
                chatId:openedChat._id
            },{
    ...
    const handleUpdate = async()=>{
        ...
        const groupName =  await axios.post(`${import.meta.env.VITE_URL}/api/chat/rename`,
            {
                chatId:openedChat._id,
                chatName:updateName
            },
